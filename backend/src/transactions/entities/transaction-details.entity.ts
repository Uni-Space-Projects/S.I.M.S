...
export class TransactionDetail {
  ...
  @ManyToOne(() => Transaction, (transaccion) => transaccion.detalles, { onDelete: 'CASCADE' })
  ...
  constructor(id?: number, transaccion?: Transaction, usuarioEmisor?: UserEntity, usuarioReceptor?: UserEntity, publicacion?: Publication, cantidad?: number) {
    if (id) this.id = id;
