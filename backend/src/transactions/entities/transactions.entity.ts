...
export class Transaction {
  ...
  @OneToMany(() => TransactionDetail, (detail) => detail.transaccion, { cascade: true })
  detalles: TransactionDetail[];

  constructor(id?: number, estado?: TransactionState, calificacion?: number, detalles?: TransactionDetail[]) {
    if (id) this.id = id;
